...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='user',
            name='managed_area',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='executives', to='core.area'),
        ),
        migrations.AddField(
            model_name='user',
            name='managed_district',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='executives', to='core.district'),
        ),
        migrations.AddField(
            model_name='user',
