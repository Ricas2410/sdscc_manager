...
DEPRECATED: Year-as-state architecture - These models are preserved for historical reference only.
New reporting should use date filtering on core tables instead of archive tables.
...
class YearlyArchive(TimeStampedModel):
    """DEPRECATED: Base model for yearly archived data - Preserved for historical reference only"""
...
class FinancialArchive(YearlyArchive):
    """DEPRECATED: Archived financial data for a fiscal year - Preserved for historical reference only"""
...
class MemberArchive(YearlyArchive):
    """DEPRECATED: Archived member statistics for a fiscal year - Preserved for historical reference only"""
...
class BranchArchive(YearlyArchive):
    """DEPRECATED: Archived branch-specific data for a fiscal year - Preserved for historical reference only"""
